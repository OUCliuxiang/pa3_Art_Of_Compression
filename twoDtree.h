...
public:
   ...
   * buildTree.
   ...
   /**
    * some recursive operations here to help Complete 
    * function render();
    */
   void renderRecur( PNG& pngObject, twoDtree::Node* );

   /*
    *  Prune function trims subtrees as high as possible in the tree.
    *  A subtree is pruned (cleared) if at least pct within
...
private:
   ...
   */
   ...
   twoDtree::Node* copyRecur( twoDtree::Node* );
